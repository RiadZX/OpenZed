...
func (inst *WithdrawPnl) SetReferrerPcAccountAccount(referrerPcAccount ag_solanago.PublicKey) *WithdrawPnl {
	inst.AccountMetaSlice[17] = ag_solanago.Meta(referrerPcAccount)
	return inst
}

// GetReferrerPcAccountAccount gets the "referrerPcAccount" account.
func (inst *WithdrawPnl) GetReferrerPcAccountAccount() *ag_solanago.AccountMeta {
			...
			programBranch.Child(ag_format.Instruction("WithdrawPnl")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=18]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("      referrerPc", inst.AccountMetaSlice.Get(17)))
					})
				})
		})
}
...
func NewWithdrawPnlInstruction(
	...
	referrerPcAccount ag_solanago.PublicKey) *WithdrawPnl {
