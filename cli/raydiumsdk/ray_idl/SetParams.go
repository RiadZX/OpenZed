...
// SetNewAmmOpenOrdersAccountAccount sets the "newAmmOpenOrdersAccount" account.
func (inst *SetParams) SetNewAmmOpenOrdersAccountAccount(newAmmOpenOrdersAccount ag_solanago.PublicKey) *SetParams {
	inst.AccountMetaSlice[16] = ag_solanago.Meta(newAmmOpenOrdersAccount)
	return inst
}

// GetNewAmmOpenOrdersAccountAccount gets the "newAmmOpenOrdersAccount" account.
func (inst *SetParams) GetNewAmmOpenOrdersAccountAccount() *ag_solanago.AccountMeta {
...
func (inst *SetParams) Validate() error {
	...
	// Check whether all (required) accounts are set:
	{
		...
		if inst.AccountMetaSlice[16] == nil {
			return errors.New("accounts.NewAmmOpenOrdersAccount is not set")
		}
	}
	return nil
}
			...
			programBranch.Child(ag_format.Instruction("SetParams")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=17]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("newAmmOpenOrders", inst.AccountMetaSlice.Get(16)))
					})
				})
		})
}
...
func NewSetParamsInstruction(
	...
	ammAdminAccount ag_solanago.PublicKey,
	newAmmOpenOrdersAccount ag_solanago.PublicKey) *SetParams {
	return NewSetParamsInstructionBuilder().
		...
		SetNewAmmOpenOrdersAccountAccount(newAmmOpenOrdersAccount)
}
