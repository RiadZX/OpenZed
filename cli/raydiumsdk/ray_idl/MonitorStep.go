...
type MonitorStep struct {
	...
	// [18] = [WRITE] serumAsks
	//
	// [19] = [WRITE] serumFeeDiscount
	//
	// [20] = [WRITE] referrerPcAccount
...
// SetSerumFeeDiscountAccount sets the "serumFeeDiscount" account.
func (inst *MonitorStep) SetSerumFeeDiscountAccount(serumFeeDiscount ag_solanago.PublicKey) *MonitorStep {
	inst.AccountMetaSlice[19] = ag_solanago.Meta(serumFeeDiscount).WRITE()
	return inst
}

// GetSerumFeeDiscountAccount gets the "serumFeeDiscount" account.
func (inst *MonitorStep) GetSerumFeeDiscountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(19)
}

// SetReferrerPcAccountAccount sets the "referrerPcAccount" account.
func (inst *MonitorStep) SetReferrerPcAccountAccount(referrerPcAccount ag_solanago.PublicKey) *MonitorStep {
	inst.AccountMetaSlice[20] = ag_solanago.Meta(referrerPcAccount).WRITE()
	return inst
}

// GetReferrerPcAccountAccount gets the "referrerPcAccount" account.
func (inst *MonitorStep) GetReferrerPcAccountAccount() *ag_solanago.AccountMeta {
...
func (inst *MonitorStep) Validate() error {
	...
	// Check whether all (required) accounts are set:
	{
		...
		if inst.AccountMetaSlice[19] == nil {
			return errors.New("accounts.SerumFeeDiscount is not set")
		}
		if inst.AccountMetaSlice[20] == nil {
			return errors.New("accounts.ReferrerPcAccount is not set")
		}
	}
	return nil
}
			...
			programBranch.Child(ag_format.Instruction("MonitorStep")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=21]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta(" serumFeeDiscount", inst.AccountMetaSlice.Get(19)))
						accountsBranch.Child(ag_format.Meta("       referrerPc", inst.AccountMetaSlice.Get(20)))
					})
				})
		})
}
...
func NewMonitorStepInstruction(
	...
	serumFeeDiscount ag_solanago.PublicKey,
	referrerPcAccount ag_solanago.PublicKey) *MonitorStep {
	return NewMonitorStepInstructionBuilder().
		...
		SetSerumFeeDiscountAccount(serumFeeDiscount).
		SetReferrerPcAccountAccount(referrerPcAccount)
}
