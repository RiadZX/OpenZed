...
func (inst *SwapBaseIn) SetDiscriminator() *SwapBaseIn {
	inst.Discriminator = &nine
	return inst
}
...
func (inst *SwapBaseIn) Validate() error {
	...
	{
		if inst.Discriminator == nil {
			return errors.New("Discriminator parameter is not set")
		}
			...
			programBranch.Child(ag_format.Instruction("SwapBaseIn")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Params[len=3]").ParentFunc(func(paramsBranch ag_treeout.Branches) {
						paramsBranch.Child(ag_format.Param("   Discriminator", *inst.Discriminator))
